...
public abstract class Messages {
    ...
    public static final String SERVER_ERROR_2 = "Something went wrong with the server. Connection closing...";
    public static final String SERVER_ERROR_3 = "Something went wrong with your connection";
